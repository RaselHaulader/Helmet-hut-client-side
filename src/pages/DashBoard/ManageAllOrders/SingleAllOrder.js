        ...
        >
            ...
            <Item sx={{ alignItems: 'center', justifyContent: 'center', flexDirection: 'column', display: 'flex', textAlign: { md: 'center' } }}>
                {status === 'pending' ?
                    <Button
                        ...
                        onClick={() => handleUpdateOrder(_id, 'Shipped')}>
                        Shippe
                    </Button> :
                    <Button
                        color="success"
                        ...
                        sx={{ width: '100%', bgcolor: 'MediumAquaMarine' }}
                        onClick={() => handleUpdateOrder(_id, 'Delivered')}>
                        Delivered
                    </Button>
                }
            </Item>
            <Item
                ...
                <Button
                    size="small"
                    color='error'
                    sx={{ width: '100%', bgcolor: '#fd3b3b4f' }}
                    onClick={() => handleUpdateOrder(_id, 'delete')}>
                    Delete
                </Button>
            </Item>
        </Box>
